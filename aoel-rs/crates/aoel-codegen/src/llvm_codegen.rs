...
//!
//! Generates LLVM IR text format from compiled AOEL functions.
...
impl LlvmCodeGenerator {
    ...
    fn generate_header(&mut self) {
        self.writeln("; AOEL Generated LLVM IR");
        ...
        self.writeln("; AOEL Value type (tagged union)");
    ...
    fn block_has_terminator(&self, instructions: &[aoel_ir::Instruction], start: usize, end: usize) -> bool {
