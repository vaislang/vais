//! AOEL Documentation Generator
//!
//! Generate documentation from AOEL source code.
//! Supports Markdown, HTML, and JSON output formats.

use aoel_ast::{Program, Item, FunctionDef, TypeExpr};
...
impl DocGenerator {
    ...
    fn generate_html(&self, module: &ModuleDoc) -> String {
        ...
        output.push_str(&format!("  <title>{} - AOEL Documentation</title>\n", module.name));
