const messages = {
  en: {
    ...
    'status.examples.value': '137 examples',
    'start.eyebrow': 'Start',
    ...
    'compiler.body': 'The native driver links the reusable self-host compiler core, emits LLVM IR, and uses clang for native binaries. Standalone installs are produced from this repository.',
  ...
  ko: {
    ...
    'compiler.body': 'Native driver는 재사용 가능한 self-host compiler core를 링크하고 LLVM IR을 생성한 뒤 clang으로 native binary를 만듭니다. Standalone install도 이 repository에서 생성합니다.',
