const messages = {
  en: {
    ...
    'compiler.body': 'The native driver links the reusable self-host compiler core, emits LLVM IR, and uses clang for native binaries. The v0.3.2 release publishes standalone archives for Linux x64, macOS arm64, and macOS x64.',
  ...
  ko: {
    ...
    'compiler.body': 'Native driver는 재사용 가능한 self-host compiler core를 링크하고 LLVM IR을 생성한 뒤 clang으로 native binary를 만듭니다. v0.3.2 릴리스는 Linux x64, macOS arm64, macOS x64 standalone archive를 게시합니다.',
