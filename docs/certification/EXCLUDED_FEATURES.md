...
<!-- Generated by scripts/render-excluded-features.py from master-plan.toml v37. -->
<!-- DO NOT HAND-EDIT this section. Edit master-plan.toml then run the script. -->

## Active promotion candidates

Active promotion candidates are tracked exclusively in ROADMAP Master Plan v37 §Phase A2 with formal subset predicates. Each requires lifecycle stage 1 (impact preflight) before assignment.
...
| A4-15 | Escape closure: closure returned from function loses captured environment | `vais-codegen closure lowering — capture frame on caller stack, freed at return` | fn make_adder(x: i64) -> |i64| -> i64 { |n| n + x }; main: add5 := make_adder(5); add5(37); expects 42 | exit 42 (= 37 + 5; closure preserves captured x=5) | exit ≠ 42 (varies — stack-after-return corruption; capture frame freed before call) |
