...
<!-- Generated by scripts/render-excluded-features.py from master-plan.toml v109. -->
<!-- DO NOT HAND-EDIT this section. Edit master-plan.toml then run the script. -->

## Active promotion candidates

Active promotion candidates are tracked exclusively in ROADMAP Master Plan v109 §Phase A2 with formal subset predicates. Each requires lifecycle stage 1 (impact preflight) before assignment.
...
**Status**: v1-verified (single-sentinel discovery 2026-05-03); v2 retro-validation pending Order step 7. v17 (2026-05-04): A4-03/05/07 reclassified to Controlled per F-16/F-17/F-21 (IR-internal lowering, not user-facing source semantics). v23 (2026-05-05): A4-13 added — Box ↔ T silent accept at type-check call site (reclassified from rejected per STEP7 F-24 + permanent fixture A4-13_box_t_auto_unwrap). v25 (2026-05-05): empirical re-audit on all 12 fixtures — 8 entries were strict-default LANDED (env opt-out only), A4-13 was still silent, A4-03/05/07 stayed Controlled per v17, and A4-10/A4-11 were added to inventory. v47 (2026-05-08): A4-03 reclassified Controlled → A4 (runtime_silent) per loop 41 iter 3 finding. v99 (2026-05-11): A4-13 direct Box<T> ↔ T is default-strict with VAIS_REJECT_A4_13=0 legacy opt-out. v100 (2026-05-11): A4-14 Vec↔Slice resolved as specified-safe coercion with Inkwell/Text call-boundary materialization and Vec literal initialization; remaining still_silent entry is A4-03. v101 (2026-05-11): A4-03 strict audit now rejects concrete Ref/value mismatches while avoiding unresolved inference-glue false positives; strict std is 82/82 and strict vaisdb is 207/261, with default baseline unchanged. v102 (2026-05-12): A4-03 strict-mode source migration is clean for vaisdb at 261/261 while default baseline remains unchanged. v103 (2026-05-12): A4-03 is default-strict with VAIS_REJECT_A4_03=0 legacy opt-out; A4 still_silent_count is 0; full integrity is OK.
