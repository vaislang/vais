...
local `Map<Int,Bool>`, local `List<Struct>`, list ABI, list assignment, and
returned-list argument hoisting success fixtures into Vais code with the same emitted-IR shape checks
