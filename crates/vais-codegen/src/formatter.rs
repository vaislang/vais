...
impl Formatter {
    ...
    fn format_macro(&mut self, m: &MacroDef) {
    ...
    fn format_macro_pattern_element(&mut self, element: &MacroPatternElement) {
        match element {
    ...
    fn format_macro_template(&mut self, template: &MacroTemplate) {
        self.output.push('{');
        match template {
            MacroTemplate::Empty => {}
    ...
    fn format_macro_template_element(&mut self, element: &MacroTemplateElement) {
        match element {
    ...
    fn format_macro_token(&mut self, token: &MacroToken) {
        match token {
