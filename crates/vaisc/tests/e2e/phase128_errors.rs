...
fn e2e_p128_err_type_mismatch_int_for_bool() {
    ...
    let _ = compile_to_ir(r#"fn main() -> bool = 42"#);
}

#[test]
fn e2e_p128_err_type_mismatch_string_for_bool() {
    assert_error_contains(r#"fn main() -> bool = "hello""#, "mismatch");
}

#[test]
fn e2e_p128_err_type_mismatch_add_bool_int() {
    assert_error_contains(r#"fn main() -> i64 = true + 1"#, "mismatch");
}
...
fn e2e_p128_err_undef_var_in_expr() {
    assert_error_contains(r#"fn main() -> i64 = x + 1"#, "undefined");
}
...
fn e2e_p128_err_undef_fn_call() {
    assert_error_contains(r#"fn main() -> i64 = nonexistent()"#, "undefined");
}
...
fn e2e_p128_err_self_call_in_main() {
    assert_compile_error(r#"fn main() -> i64 = @(5)"#);
}
...
fn e2e_p128_err_subtract_strings() {
    assert_error_contains(r#"fn main() -> i64 = "a" - "b""#, "mismatch");
}

#[test]
fn e2e_p128_err_multiply_bools() {
    assert_error_contains(r#"fn main() -> i64 = true * false"#, "mismatch");
}

#[test]
fn e2e_p128_err_negate_string() {
    assert_compile_error(r#"fn main() -> i64 = -"hello""#);
}
