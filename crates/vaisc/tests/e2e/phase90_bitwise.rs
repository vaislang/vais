...
fn e2e_bit_or_basic() {
    // 0xF0 | 0x0F = 0xFF = 255
    assert_exit_code("fn main()->i64 = 240 | 15", 255);
}

#[test]
fn e2e_bit_xor_basic() {
    // 0xFF ^ 0xAA = 0x55 = 85
    assert_exit_code("fn main()->i64 = 255 ^ 170", 85);
}
...
fn e2e_bit_and_zero() {
    // x & 0 = 0
    assert_exit_code("fn main()->i64 = 12345 & 0", 0);
}
...
fn e2e_bit_shl_basic() {
    // 1 << 5 = 32
    assert_exit_code("fn main()->i64 = 1 << 5", 32);
}

#[test]
fn e2e_bit_shr_basic() {
    // 256 >> 3 = 32
    assert_exit_code("fn main()->i64 = 256 >> 3", 32);
}
...
fn e2e_bit_is_even() {
    let source = r#"
fn is_even(x: i64) -> i64 = 1 - (x & 1)
fn main() -> i64 = is_even(42)
"#;
...
fn e2e_bit_is_odd() {
    let source = r#"
fn is_odd(x: i64) -> i64 = x & 1
fn main() -> i64 = is_odd(43)
"#;
    assert_exit_code(source, 1);
}
...
fn e2e_bit_low_nibble() {
    let source = r#"
fn low_nibble(x: i64) -> i64 = x & 15
fn main() -> i64 = low_nibble(42)
"#;
...
fn e2e_bit_high_nibble() {
    let source = r#"
fn high_nibble(x: i64) -> i64 = (x >> 4) & 15
fn main() -> i64 = high_nibble(42)
"#;
...
fn e2e_bit_swap_nibbles() {
    let source = r#"
fn swap_nibbles(x: i64) -> i64 = ((x & 15) << 4) | ((x >> 4) & 15)
fn main() -> i64 = swap_nibbles(0)
"#;
    assert_exit_code(source, 0);
}
...
fn e2e_bit_set_bit() {
    let source = r#"
fn set_bit(x: i64, pos: i64) -> i64 = x | (1 << pos)
fn main() -> i64 = set_bit(40, 1)
"#;
    // 40 | 2 = 42
    assert_exit_code(source, 42);
}
...
fn e2e_bit_clear_bit() {
    let source = r#"
fn clear_bit(x: i64, pos: i64) -> i64 = x & (255 - (1 << pos))
fn main() -> i64 = clear_bit(46, 2)
"#;
