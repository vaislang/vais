...
expect_exit "vaismake gates.tasks parses" 16 "$vmake_dist/bin/vaismake" "$ROOT/tools/gates.tasks"
...
expect_exit "vaisbox list count" 0 /bin/sh -c "'$vbox_bin/vaisbox' list | wc -l | grep -q 13"
