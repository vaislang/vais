...
| **Phase 49** | VaisDB 대응: 크로스 플랫폼 & SIMD | 🔄 진행 중 — Stage 0 완료, Stage 1-2 진행 예정 | 354 |
...
- [ ] GitHub Actions Linux 매트릭스에서 std/net, std/file, std/signal E2E 통과
- [ ] TCP 서버 bind/accept/connect 테스트 (Linux)
- [ ] mmap/flock 테스트 (Linux)
- [ ] Docker 기반 Linux 통합 테스트 환경 구축
- **난이도**: 중 | **모델**: Sonnet 위임
