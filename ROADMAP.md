...
- [ ] 7. vais-monitor main_anomaly.ll codegen 시그니처 불일치 해결 (Opus direct)
  [이슈]: `@anomaly_result_to_json` declare vs call 간 return type / str arg type / bool↔i64 불일치 3종
  [대상 파일]: 컴파일러 codegen call/signature resolution 경로
