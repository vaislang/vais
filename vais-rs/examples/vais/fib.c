...
static Value vais_fib(Value vais_n) {
    Value _stack[256];
    int _sp = 0;
    ...
    L2: ;
    { Value b = _stack[--_sp]; Value a = _stack[--_sp]; _stack[_sp++] = val_lte(a, b); }
    L3: ;
    if (!_stack[--_sp].data.b) goto L6;
    L4: ;
    _stack[_sp++] = vais_n;
    L5: ;
    goto L15;
    ...
    _stack[_sp++] = val_int(1LL);
    L8: ;
    { Value b = _stack[--_sp]; Value a = _stack[--_sp]; _stack[_sp++] = val_sub(a, b); }
    L9: ;
    {
        Value _arg0 = _stack[_sp - 0 - 1];
        _sp -= 1;
        _stack[_sp++] = vais_fib(_arg0);
    }
    L10: ;
    _stack[_sp++] = vais_n;
    L11: ;
    ...
    L14: ;
    { Value b = _stack[--_sp]; Value a = _stack[--_sp]; _stack[_sp++] = val_add(a, b); }
    L15: ;
    return _stack[--_sp];
...
static Value vais___main__(void) {
    Value _stack[256];
    int _sp = 0;
    
    L0: ;
    _stack[_sp++] = val_int(20LL);
    L1: ;
    {
        Value _arg0 = _stack[_sp - 0 - 1];
        _sp -= 1;
