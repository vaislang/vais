...
entry:
  %0 = alloca [4  x i64]
  ; DCE removed: %1 = getelementptr [4  x i64], [4  x i64]* %0, i64 0, i64 0
  ; dead store eliminated: store i64 10, i64* %1
  ; DCE removed: %2 = getelementptr [4  x i64], [4  x i64]* %0, i64 0, i64 1
  ; dead store eliminated: store i64 20, i64* %2
  ; DCE removed: %3 = getelementptr [4  x i64], [4  x i64]* %0, i64 0, i64 2
  ; dead store eliminated: store i64 30, i64* %3
  ; DCE removed: %4 = getelementptr [4  x i64], [4  x i64]* %0, i64 0, i64 3
  ; dead store eliminated: store i64 40, i64* %4
...
entry:
  %0 = inttoptr i64 %ptr to i8*
  ; DCE removed: %1 = trunc i64 %val to i8
  ; dead store eliminated: store i8 %1, i8* %0
  ret void
}
...
entry:
  %0 = inttoptr i64 %ptr to i64*
  ; dead store eliminated: store i64 %val, i64* %0
  ret void
}
...
entry:
  %0 = inttoptr i64 %ptr to double*
  ; dead store eliminated: store double %val, double* %0
  ret void
}
