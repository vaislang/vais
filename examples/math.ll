...
entry:
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0), i64 %2)
  %4 = sext i32 %3 to i64
  %5 = call i64 @mul(i64 5, i64 6)
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr ([17 x i8], [17 x i8]* @.str.2, i64 0, i64 0), i64 %5)
  %7 = sext i32 %6 to i64
  %8 = call i64 @square(i64 7)
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr ([17 x i8], [17 x i8]* @.str.3, i64 0, i64 0), i64 %8)
