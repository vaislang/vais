...
entry:
  ...
  %1 = sext i32 %0 to i64
  %2 = call i32 @puts(i8* getelementptr ([24 x i8], [24 x i8]* @.str.1, i64 0, i64 0))
  %3 = sext i32 %2 to i64
  %i.4 = alloca i64
  store i64 0, i64* %i.4
...
merge5:
  ...
  %15 = load i64, i64* %i.4
  %16 = add i64 %15, 1
  store i64 %16, i64* %i.4
  br label %loop.start0
loop.end2:
  %17 = trunc i64 10 to i32
  %18 = call i32 @putchar(i32 %17)
  %19 = sext i32 %18 to i64
  %20 = call i32 @puts(i8* getelementptr ([13 x i8], [13 x i8]* @.str.2, i64 0, i64 0))
