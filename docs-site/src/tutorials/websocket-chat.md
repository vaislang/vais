...
N "C" {
    ...
    fn __malloc(size: i64) -> i64
    fn __free(ptr: i64) -> i64
}
...
# WebSocket 런타임 함수들
N "C" {
    fn __ws_parse_upgrade_request(buffer: i64, len: i64) -> i64
    fn __ws_accept_key(client_key: i64) -> i64
    fn __ws_build_upgrade_response(accept_key: i64, out_buffer: i64) -> i64
    fn __find_header_end(buffer: i64, len: i64) -> i64
    fn __strlen(s: str) -> i64
}

fn do_handshake(fd: i64) -> i64 {
    buf := __malloc(8192)
    I buf == 0 { return 0 }
...
N "C" {
    fn __ws_encode_frame(opcode: i64, payload: i64, payload_len: i64,
                        masked: i64, mask_key: i64, out_frame: i64) -> i64
    fn __ws_decode_frame(data: i64, data_len: i64, out_frame: i64) -> i64
    fn __load_i64(ptr: i64) -> i64
}

fn ws_send_text(fd: i64, msg: str) -> i64 {
...
```vais
fn handle_client_safe(fd: i64) -> i64 {
    recv_buf := __malloc(65550)
