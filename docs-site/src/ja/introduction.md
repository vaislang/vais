...
- **セルフホスティング** - セルフホスティングコンパイラ(bootstrap達成) — v0.9.0、51,190 LOC、58 .vaisファイル
...
**セルフホスティング:** セルフホスティングコンパイラ(bootstrap達成) — v0.9.0、51,190 LOC、58 .vaisファイルがネイティブバイナリへコンパイル可能。
...
- ✅ セルフホスティングコンパイラ (bootstrap達成 — v0.9.0、51,190 LOC、58 .vaisファイル)
