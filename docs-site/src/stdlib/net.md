...
fn handle_client(client: TcpStream) -> i64 {
    buffer := malloc(1024)
...
fn http_get(host: i64, path: i64) -> i64 {
...
fn worker_thread(client_ptr: i64) -> i64 {
...
fn nonblocking_client(host: i64, port: i64) -> i64 {
    client := TcpStream::connect(host, port)
    I !client.is_valid() { return 1 }
...
```vais
fn send_all(sock: TcpStream, data: i64, len: i64) -> i64 {
    sent := 0
    L sent < len {
