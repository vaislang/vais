...
fn hash_password(password: i64, salt: i64) -> i64 {
    # Salt + Password 조합
...
fn verify_password(password: i64, salt: i64, stored_hash: i64) -> i64 {
...
fn encrypt_message(message: i64, key: i64) -> i64 {
    aes := Aes256::new(key)
...
fn decrypt_message(encrypted: i64, key: i64) -> i64 {
    aes := Aes256::new(key)
...
fn send_authenticated_message(socket: TcpStream, message: i64, secret: i64) -> i64 {
    # HMAC 계산
...
fn recv_authenticated_message(socket: TcpStream, secret: i64) -> i64 {
    # 메시지 수신
    message := malloc(1024)
...
# 좋은 예: 상수 시간 비교
fn secure_compare(a: i64, b: i64, len: i64) -> i64 {
    result := 0
    i := 0
    L i < len {
