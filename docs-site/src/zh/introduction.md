...
Apple ARM64/macOS) 中，4 个 benchmark programs 的 Vais `--emit-ir`
平均值为 6.3ms。该数据比较的是 Vais LLVM IR emission 与其他 toolchain 的
full binary compilation，属于 scoped benchmark claim。
